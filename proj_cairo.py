...
if __name__ == "__main__":
	...
	m=StarsMap(magLim=8,projection="airy +lat_0=42  +ellps=sphere +R=1.4",paper=landscape(A3),costellation_list='',city='Madrid',altaz=1,date=ephem.now()+ephem.hour*24*0+ephem.hour*10)
